...
<Case title="Case 1 — bread and butter HMB">
  <Stage title="Stage 1 — presenting complaint" open>
  ...
  <Stage title="Stage 2 — more history">
  ...
  <Stage title="Stage 3 — results and planning">
...
<Case title="Case 2 — HMB + IMB (investigation needed)">
  ...
  <Stage title="Stage 2 — exam and safety">
...
<Case title="Case 3 — HMB on anticoagulation">
  <Stage title="Stage 1 — presenting complaint" open>
